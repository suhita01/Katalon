...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'abcd')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), '')

WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'))

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'efgh')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), '')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'))
