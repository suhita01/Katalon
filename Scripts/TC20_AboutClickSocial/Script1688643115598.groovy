...
WebUI.click(findTestObject('Object Repository/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/body_iframe srchttpswww.googletagmanager.co_b8b147'))

WebUI.click(findTestObject('Object Repository/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/body_iframe srchttpswww.googletagmanager.co_1f3fab'))

WebUI.click(findTestObject('Object Repository/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/img'))
