...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/body_You need to enable JavaScript to run t_dc39c4'))
...
WebUI.click(findTestObject('Page_Swag Labs/div_1'))

WebUI.doubleClick(findTestObject('Page_Swag Labs/body_You need to enable JavaScript to run t_5a8ad9'))

WebUI.click(findTestObject('Page_Swag Labs/body_You need to enable JavaScript to run t_5a8ad9'))

WebUI.doubleClick(findTestObject('Page_Swag Labs/div_1'))
...
WebUI.click(findTestObject('Page_Swag Labs/div_Continue ShoppingCheckout'))

WebUI.click(findTestObject('Page_Swag Labs/button_Close Menu'))
